...
package com.algorand.android.accountcore.ui.asset.assetdrawable
...
interface GetAssetDrawableProvider {
    ...
    operator fun invoke(asset: Asset): BaseAssetDrawableProvider
    suspend operator fun invoke(assetId: Long): BaseAssetDrawableProvider
