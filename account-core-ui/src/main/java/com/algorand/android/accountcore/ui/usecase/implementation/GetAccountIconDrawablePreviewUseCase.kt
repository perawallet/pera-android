...
internal class GetAccountIconDrawablePreviewUseCase @Inject constructor(
    ...
    private fun getAccountIconBackgroundColorResId(accountType: AccountType?): Int {
        return when (accountType) {
            AccountType.Algo25 -> com.algorand.android.accountcore.ui.model.AccountIconResource.STANDARD.backgroundColorResId
            AccountType.LedgerBle -> com.algorand.android.accountcore.ui.model.AccountIconResource.LEDGER.backgroundColorResId
            AccountType.Rekeyed -> R.color.negative_lighter
            AccountType.RekeyedAuth -> com.algorand.android.accountcore.ui.model.AccountIconResource.REKEYED.backgroundColorResId
            AccountType.NoAuth -> com.algorand.android.accountcore.ui.model.AccountIconResource.WATCH.backgroundColorResId
    ...
    private fun getAccountIconTintResId(accountType: AccountType?): Int {
        return when (accountType) {
            AccountType.Algo25 -> com.algorand.android.accountcore.ui.model.AccountIconResource.STANDARD.iconTintResId
            AccountType.Rekeyed -> R.color.negative
            AccountType.LedgerBle -> com.algorand.android.accountcore.ui.model.AccountIconResource.LEDGER.iconTintResId
            AccountType.RekeyedAuth -> com.algorand.android.accountcore.ui.model.AccountIconResource.LEDGER.iconTintResId
            AccountType.NoAuth -> com.algorand.android.accountcore.ui.model.AccountIconResource.WATCH.iconTintResId
    ...
    private fun getAccountIconResId(accountType: AccountType?): Int {
        return when (accountType) {
            AccountType.Algo25 -> com.algorand.android.accountcore.ui.model.AccountIconResource.STANDARD.iconResId
            AccountType.LedgerBle -> com.algorand.android.accountcore.ui.model.AccountIconResource.LEDGER.iconResId
            AccountType.NoAuth -> com.algorand.android.accountcore.ui.model.AccountIconResource.WATCH.iconResId
            AccountType.Rekeyed, AccountType.RekeyedAuth -> R.drawable.ic_rekey_shield
            null -> com.algorand.android.accountcore.ui.model.AccountIconResource.STANDARD.iconResId
        }
    }
}
