...
internal interface AsaStatusPreviewMapper {
    ...
    suspend fun mapToCollectibleAdditionStatus(accountAddress: String): AsaStatusPreview.AdditionStatus

    suspend fun mapToCollectibleRemovalStatus(accountAddress: String): CollectibleRemovalStatus
}
