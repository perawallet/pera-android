...
interface GetUpdatedCustomRange {
    operator fun invoke(
...
interface GetDefaultCustomRange {
    operator fun invoke(): DateFilter.CustomRange
}

interface GetDateFilterList {
    operator fun invoke(dateFilter: DateFilter?, dateFilterList: MutableList<DateFilter>): List<DateFilter>
}
