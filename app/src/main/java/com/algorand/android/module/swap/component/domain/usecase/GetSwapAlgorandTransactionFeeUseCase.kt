...
internal class GetSwapAlgorandTransactionFeeUseCase @Inject constructor() : GetSwapAlgorandTransactionFee {

    override fun invoke(transactions: Array<SwapQuoteTransaction>): Long {
