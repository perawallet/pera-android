...
import com.algorand.android.module.transaction.component.domain.validator.OptOutAssetCreatorValidator.Payload
import javax.inject.Inject

internal class OptOutAssetCreatorValidator @Inject constructor() : TransactionValidator<Payload, Unit> {

    override suspend fun invoke(payload: Payload): ValidationResult<Unit> {
        val isValid = payload.senderAddress != payload.assetCreatorAddress
