...
class CreateArc59OptInTransactionUseCase @Inject constructor(
    private val accountDetailUseCase: AccountDetailUseCase,
    private val isOnTestnetUseCase: IsOnTestnetUseCase
) : CreateArc59OptInTransaction {

    override fun invoke(txnParams: TransactionParams, payload: Arc59TransactionPayload): List<Arc59OptInTransaction> {
        ...
        val transactions = txnParams.createTransactions(payload.senderAddress, payload.assetId)
        return transactions.map { transactionByteArray ->
            Arc59OptInTransaction(
    ...
    private fun TransactionParams.createTransactions(address: String, assetId: Long): MutableList<ByteArray> {
        ...
        val transactions = Sdk.makeARC59OptInTxn(address, appAddress, appId, assetId, toSuggestedParams())
