...
package com.algorand.android.modules.autolockmanager.data.repository
...
class AutoLockRepositoryImpl(
    ...
    override fun setAppAtBackgroundTime(appAtBackgroundTime: Long) {
        appAtBackgroundPreferencesLocalSource.saveData(appAtBackgroundTime)
    }

    override fun getAppAtBackgroundTime(): Long? {
        return appAtBackgroundPreferencesLocalSource.getDataOrNull()
    }
}
