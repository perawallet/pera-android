...
class CollectibleNoMediaViewHolder(
    binding: ItemNftMediaBinding,
    listener: Listener
    ...
    companion object {
        fun create(parent: ViewGroup, listener: Listener): CollectibleNoMediaViewHolder {
            val binding = ItemNftMediaBinding.inflate(LayoutInflater.from(parent.context), parent, false)
            return CollectibleNoMediaViewHolder(binding, listener)
        }
    }
}
