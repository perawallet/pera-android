...
object FetchNameServicesModule {

    @Provides
    @Named(FetchNameServicesRepository.INJECTION_NAME)
    fun provideReadNameServicesRepository(
        mobileAlgorandApi: MobileAlgorandApi,
        hipoApiErrorHandler: RetrofitErrorHandler,
        nameServicesDTOMapper: NameServicesDTOMapper
    ): FetchNameServicesRepository {
        return FetchNameServicesRepositoryImpl(mobileAlgorandApi, hipoApiErrorHandler, nameServicesDTOMapper)
    }
}
