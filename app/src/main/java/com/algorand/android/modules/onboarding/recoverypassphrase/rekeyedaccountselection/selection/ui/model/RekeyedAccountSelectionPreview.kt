...
data class RekeyedAccountSelectionPreview(
    override val isLoading: Boolean,
    override val foundAccountSelectionListItem: List<BaseFoundAccountSelectionItem>,
    val showAccountCountExceedErrorEvent: Event<Unit>?,
