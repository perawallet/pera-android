...
package com.algorand.android.modules.rekey.rekeytoledgeraccount.confirmation.ui.mapper
...
class RekeyToLedgerAccountConfirmationPreviewMapper @Inject constructor() {

    @SuppressWarnings("LongParameterList")
    fun mapToRekeyToLedgerAccountConfirmationPreview(
        isLoading: Boolean,
        titleTextResId: Int,
        ...
        return RekeyToLedgerAccountConfirmationPreview(
            isLoading = isLoading,
