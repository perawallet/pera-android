...
package com.algorand.android.modules.walletconnect.domain.di
...
import com.algorand.android.modules.walletconnect.domain.usecase.GetWalletConnectTransactionAuthAddressUseCase
...
internal object WalletConnectDomainModule {
    ...
    @Provides
    @Singleton
    fun provideGetWalletConnectTransactionAuthAddress(
        useCase: GetWalletConnectTransactionAuthAddressUseCase
    ): GetWalletConnectTransactionAuthAddress = useCase
}
