...
interface CreateWalletConnectAccount {
    suspend operator fun invoke(address: String?): WalletConnectAccount?
}

interface GetWalletConnectTransactionAuthAddress {
    suspend operator fun invoke(senderAddress: String?, signer: WalletConnectTransactionSigner): String?
}
