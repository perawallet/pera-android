...
class ImportBackupResponseDTOMapper @Inject constructor() {
    ...
    fun mapToImportBackupResponseDTO(importBackupResponse: ImportBackupResponse): ImportBackupResponseDTO {
        with(importBackupResponse) {
            return ImportBackupResponseDTO(
                id = id,
                type = type,
