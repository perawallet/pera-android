...
class ContactViewHolder(
    ...
    fun bind(contact: Contact) {
        binding.userImageView.setContactIconDrawable(contact.imageUri?.toUri(), R.dimen.account_icon_size_large)
        binding.nameTextView.text = contact.name
        binding.addressTextView.text = contact.address.toShortenedAddress()
    }
