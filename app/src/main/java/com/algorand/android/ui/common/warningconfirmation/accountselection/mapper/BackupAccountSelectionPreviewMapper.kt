...
class BackupAccountSelectionPreviewMapper @Inject constructor() {

    fun mapToBackupAccountSelectionPreview(
        accountSelectionListItems: List<BaseAccountSelectionListItem>
    ): BackupAccountSelectionPreview {
        return BackupAccountSelectionPreview(accountSelectionListItems)
    }
}
