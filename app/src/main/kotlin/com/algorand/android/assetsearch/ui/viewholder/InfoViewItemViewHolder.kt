...
class InfoViewItemViewHolder(
    ...
    companion object {
        fun create(parent: ViewGroup): InfoViewItemViewHolder {
            val binding = ItemCollectibleInfoViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
            return InfoViewItemViewHolder(binding)
        }
    }
}
