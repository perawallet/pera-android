...
abstract class TransactionSignBaseFragment(
    ...
    private var bleWaitingGroupTransactionData: List<TransactionSignData>? = null
...
//                    we will display [CustomSnackbar] here as well.
    ...
    fun sendTransaction(transactionData: TransactionSignData) {
        if (transactionData.signer is TransactionSigner.LedgerBle) {
        ...
        val hasAccountAuthority = transactionData.signer !is TransactionSigner.SignerNotFound
