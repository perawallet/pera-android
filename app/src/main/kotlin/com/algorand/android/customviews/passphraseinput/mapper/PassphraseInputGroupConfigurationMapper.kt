...
class PassphraseInputGroupConfigurationMapper @Inject constructor() {

    fun mapToPassphraseInputGroupConfiguration(
        passphraseInputConfigurationList: List<PassphraseInputConfiguration>,
        focusedPassphraseItem: PassphraseInputConfiguration? = null,
        unfocusedPassphraseItem: PassphraseInputConfiguration? = null,
    ): PassphraseInputGroupConfiguration {
        return PassphraseInputGroupConfiguration(
            passphraseInputConfigurationList = passphraseInputConfigurationList,
            focusedPassphraseItem = focusedPassphraseItem,
            unfocusedPassphraseItem = unfocusedPassphraseItem
        )
    }
}
