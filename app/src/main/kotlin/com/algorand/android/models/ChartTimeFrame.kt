...
sealed class ChartTimeFrame : Parcelable {
    ...
    object DayTimeFrame : ChartTimeFrame() {
        override val buttonDisplayResId: Int = R.string.one_day_abbr
        ...
        override fun areItemsTheSame(other: ChartTimeFrame): Boolean = other === this
        override fun areContentsTheSame(other: ChartTimeFrame): Boolean = true
    }

    @Parcelize
    object WeekTimeFrame : ChartTimeFrame() {
        override val buttonDisplayResId: Int = R.string.one_week_abbr
    ...
    object MonthTimeFrame : ChartTimeFrame() {
        override val buttonDisplayResId: Int = R.string.one_month_abbr
    ...
    object YearTimeFrame : ChartTimeFrame() {
        override val buttonDisplayResId: Int = R.string.one_year_abbr
    ...
    object AllTimeFrame : ChartTimeFrame() {
        override val buttonDisplayResId: Int = R.string.all_time_abbr
    ...
    companion object {
        val DEFAULT_TIME_FRAME: DayTimeFrame = DayTimeFrame
        ...
        const val UNDEFINED_TIME_FRAME_AS_MIN: Int = -1
    }
}
