...
sealed class WalletConnectTransactionSigner : Parcelable {
    ...
    @Parcelize
    data class Sender(override val address: WalletConnectAddress) : WalletConnectTransactionSigner() {
        override val isValidSigner: Boolean
            get() = true
    }

    @Parcelize
    data class Rekeyed(override val address: WalletConnectAddress) : WalletConnectTransactionSigner() {
        override val isValidSigner: Boolean
            get() = true
    }

    @Parcelize
    data class Unsignable(val error: WalletConnectError) : WalletConnectTransactionSigner() {
        override val isValidSigner: Boolean
            get() = false
    }

    @Parcelize
    data class Multisig(val error: WalletConnectError) : WalletConnectTransactionSigner() {
        override val isValidSigner: Boolean
            get() = false
    }

    @Parcelize
    object DisplayOnly : WalletConnectTransactionSigner() {
        override val isValidSigner: Boolean
            get() = true
    }
}
