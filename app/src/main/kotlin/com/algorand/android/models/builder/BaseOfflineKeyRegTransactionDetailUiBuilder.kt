...
class BaseOfflineKeyRegTransactionDetailUiBuilder @Inject constructor() :
    BaseKeyRegTransactionDetailUiBuilder() {

    override fun buildTransactionRequestOfflineKeyRegInfo(
        txn: BaseKeyRegTransaction
    ): TransactionRequestOfflineKeyRegInfo? {
        if (txn !is BaseOfflineKeyRegTransaction) return null
