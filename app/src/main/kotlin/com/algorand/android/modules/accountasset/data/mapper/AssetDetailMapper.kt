...
class AssetDetailMapper @Inject constructor() {
    ...
    fun map(assetDetailResponse: AccountAssetDetailResponse?): AccountAssetDetail.AssetDetail? {
        return assetDetailResponse?.assetHolding?.run {
            AccountAssetDetail.AssetDetail(
