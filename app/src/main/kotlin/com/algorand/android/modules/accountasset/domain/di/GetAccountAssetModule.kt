...
object GetAccountAssetModule {

    @Provides
    fun provideGetAccountAssetUseCase(
        accountAssetRepository: AccountAssetRepository
    ): GetAccountAssetUseCase = GetAccountAssetUseCase(accountAssetRepository::getAccountAssetDetail)
}
