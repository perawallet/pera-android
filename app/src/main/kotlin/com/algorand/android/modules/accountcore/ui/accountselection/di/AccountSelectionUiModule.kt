...
package com.algorand.android.modules.accountcore.ui.accountselection.di

import com.algorand.android.modules.accountcore.ui.accountselection.mapper.AccountSelectionListItemMapper
import com.algorand.android.modules.accountcore.ui.accountselection.mapper.AccountSelectionListItemMapperImpl
import com.algorand.android.modules.accountcore.ui.accountselection.usecase.CreateLoadedAccountConfiguration
import com.algorand.android.modules.accountcore.ui.accountselection.usecase.CreateLoadedAccountConfigurationUseCase
import com.algorand.android.modules.accountcore.ui.accountselection.usecase.CreateNotLoadedAccountConfiguration
import com.algorand.android.modules.accountcore.ui.accountselection.usecase.CreateNotLoadedAccountConfigurationUseCase
...
import com.algorand.android.modules.accountcore.ui.accountselection.usecase.GetAccountSelectionContactItemsUseCase
import com.algorand.android.modules.accountcore.ui.accountselection.usecase.GetAccountSelectionItemsFromAccountAddress
import com.algorand.android.modules.accountcore.ui.accountselection.usecase.GetAccountSelectionItemsFromAccountAddressUseCase
import com.algorand.android.modules.accountcore.ui.accountselection.usecase.GetAccountSelectionNameServiceItems
import com.algorand.android.modules.accountcore.ui.accountselection.usecase.GetAccountSelectionNameServiceItemsUseCase
...
internal object AccountSelectionUiModule {
    ...
    fun provideAccountSelectionListItemMapper(
        impl: AccountSelectionListItemMapperImpl
    ): AccountSelectionListItemMapper = impl
    ...
    @Provides
    fun provideGetAccountSelectionAccountsWhichCanSignTransaction(
