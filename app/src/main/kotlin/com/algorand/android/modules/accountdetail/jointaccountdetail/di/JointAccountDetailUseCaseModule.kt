...
internal object JointAccountDetailUseCaseModule {

    @Provides
    fun provideCreateJointAccountParticipantItem(
        useCase: CreateJointAccountParticipantItemUseCase
    ): CreateJointAccountParticipantItem = useCase
}
