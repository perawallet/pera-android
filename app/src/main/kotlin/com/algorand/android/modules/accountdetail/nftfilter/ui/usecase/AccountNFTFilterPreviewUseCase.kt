...
package com.algorand.android.modules.accountdetail.nftfilter.ui.usecase
...
class AccountNFTFilterPreviewUseCase @Inject constructor(
    private val accountNFTFilterPreviewMapper: AccountNFTFilterPreviewMapper,
    ...
    suspend fun getCollectibleFiltersPreviewFlow(): AccountNFTFilterPreview {
        val displayOptedInNFTsPreference = shouldDisplayOptedInNFTPreferenceUseCase()
        return accountNFTFilterPreviewMapper.mapToAccountNFTFilterPreview(
