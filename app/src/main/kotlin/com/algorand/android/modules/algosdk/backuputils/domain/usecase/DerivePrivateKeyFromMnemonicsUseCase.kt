...
class DerivePrivateKeyFromMnemonicsUseCase @Inject constructor(
    @Named(AlgorandSdkBackupUtils.INJECTION_NAME)
    private val algorandSdkBackupUtils: AlgorandSdkBackupUtils
) {

    suspend operator fun invoke(mnemonics: String): ByteArray? {
        return algorandSdkBackupUtils.derivePrivateKeyFromMnemonics(mnemonics)
    }
}
