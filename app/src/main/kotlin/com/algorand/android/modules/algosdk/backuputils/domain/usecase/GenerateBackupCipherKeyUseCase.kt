...
class GenerateBackupCipherKeyUseCase @Inject constructor(
    ...
    suspend operator fun invoke(input: ByteArray): ByteArray? {
        return algorandSdkBackupUtils.generateBackupCipherKey(CIPHER_KEY, input)
    }

    companion object {
        private const val CIPHER_KEY = "Algorand export 1.0"
    }
}
