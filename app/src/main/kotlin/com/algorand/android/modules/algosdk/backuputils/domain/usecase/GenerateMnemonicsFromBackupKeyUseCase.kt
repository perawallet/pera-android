...
class GenerateMnemonicsFromBackupKeyUseCase @Inject constructor(
    @Named(AlgorandSdkBackupUtils.INJECTION_NAME)
    private val algorandSdkBackupUtils: AlgorandSdkBackupUtils
) {

    suspend operator fun invoke(backupKey: ByteArray): String? {
        return algorandSdkBackupUtils.generateMnemonicsFromBackupKey(backupKey)
    }
}
