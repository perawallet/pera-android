...
import com.algorand.android.modules.algosdk.data.model.rawtransaction.RawTransactionApplicationCallStateSchemaPayload
import com.algorand.android.modules.algosdk.domain.model.dto.ApplicationCallStateSchemaDTO
import javax.inject.Inject

class ApplicationCallStateSchemaDTOMapper @Inject constructor() {

    fun mapToApplicationCallStateSchemaDTO(
        payload: RawTransactionApplicationCallStateSchemaPayload?
    ): ApplicationCallStateSchemaDTO {
        return ApplicationCallStateSchemaDTO(
