...
import com.algorand.android.modules.algosdk.data.model.rawtransaction.RawTransactionTypePayload
...
class RawTransactionTypeDTODecider @Inject constructor() {
    ...
    fun decideRawTransactionTypeDTO(rawTransactionTypePayload: RawTransactionTypePayload): RawTransactionTypeDTO {
        return when (rawTransactionTypePayload) {
            RawTransactionTypePayload.PAY_TRANSACTION -> RawTransactionTypeDTO.PAY_TRANSACTION
