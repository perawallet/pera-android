...
class AlgorandAddressMapper @Inject constructor() {

    fun mapToAlgorandAddress(dto: AlgorandAddressDTO): AlgorandAddress {
        return AlgorandAddress(
            decodedAddress = dto.address,
            addressPublicKey = dto.bytes
        )
    }
}
