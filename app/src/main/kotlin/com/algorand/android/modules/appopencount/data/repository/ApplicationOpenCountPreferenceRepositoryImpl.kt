...
class ApplicationOpenCountPreferenceRepositoryImpl @Inject constructor(
    private val applicationOpenCountPreferencesLocalSource: ApplicationOpenCountPreferencesLocalSource
) : ApplicationOpenCountPreferenceRepository {

    override suspend fun setApplicationOpenCount(count: Int) {
        applicationOpenCountPreferencesLocalSource.saveData(count)
    }
