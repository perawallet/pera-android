...
class ApplicationOpenCountPreferenceUseCase @Inject constructor(
    ...
    suspend fun setApplicationOpenCount(count: Int) {
        applicationOpenCountPreferenceRepository.setApplicationOpenCount(count)
    }

    suspend fun getApplicationOpenCount(): Int {
        return applicationOpenCountPreferenceRepository.getApplicationOpenCount()
    }
}
