...
class AsbAccountImportResultMapper @Inject constructor() {

    fun mapToAsbAccountImportResult(
        importedAccountList: List<String>,
        existingAccountList: List<String>,
        unsupportedAccountList: List<String>
    ): AsbAccountImportResult {
        return AsbAccountImportResult(
