...
import com.algorand.android.modules.asb.mnemonics.data.repository.AsbMnemonicsRepositoryImpl
...
object AsbMnemonicsModule {

    @Provides
    @Named(AsbMnemonicsRepository.INJECTION_NAME)
    fun provideAsbMnemonicsLocalSource(
        asbMnemonicsLocalSource: AsbMnemonicsLocalSource
