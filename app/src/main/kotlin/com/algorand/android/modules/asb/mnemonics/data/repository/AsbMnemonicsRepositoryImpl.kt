...
package com.algorand.android.modules.asb.mnemonics.data.repository
...
class AsbMnemonicsRepositoryImpl constructor(
    private val asbMnemonicsLocalSource: AsbMnemonicsLocalSource
) : AsbMnemonicsRepository {

    override suspend fun storeBackupMnemonics(mnemonics: String) {
        asbMnemonicsLocalSource.saveData(mnemonics)
    }

    override suspend fun getBackupMnemonics(): String? {
        return asbMnemonicsLocalSource.getDataOrNull()
    }
