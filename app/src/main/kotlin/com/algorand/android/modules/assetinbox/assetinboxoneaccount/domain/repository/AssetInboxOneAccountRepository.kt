...
package com.algorand.android.modules.assetinbox.assetinboxoneaccount.domain.repository

import com.algorand.android.models.Result
import com.algorand.android.modules.assetinbox.assetinboxoneaccount.domain.model.AssetInboxOneAccountPaginated

interface AssetInboxOneAccountRepository {

    suspend fun getAssetInboxOneAccount(
        address: String
    ): Result<AssetInboxOneAccountPaginated>

    suspend fun getAssetInboxOneAccountMore(
        nextUrl: String
    ): Result<AssetInboxOneAccountPaginated>
