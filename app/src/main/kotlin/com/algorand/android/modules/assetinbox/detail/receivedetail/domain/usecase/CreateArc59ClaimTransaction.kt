...
interface CreateArc59ClaimTransaction {
    suspend operator fun invoke(payload: Arc59ClaimTransactionPayload):
            Result<List<BaseArc59ClaimRejectTransaction.Arc59ClaimTransaction>>
}
