...
package com.algorand.android.modules.assetinbox.send.summary.data.mapper

import com.algorand.android.modules.assetinbox.send.summary.data.model.Arc59SendSummaryResponse
import com.algorand.android.modules.assetinbox.send.summary.data.model.Arc59WarningMessageResponse
import com.algorand.android.modules.assetinbox.send.summary.domain.model.Arc59SendSummary
import com.algorand.android.modules.assetinbox.send.summary.domain.model.Arc59SummaryWarningMessage
...
class Arc59SendSummaryMapperImpl @Inject constructor() : Arc59SendSummaryMapper {
    ...
    override fun invoke(response: Arc59SendSummaryResponse?): Arc59SendSummary? {
        ...
        return Arc59SendSummary(
            ...
            warningMessage = mapToArc59WarningMessage(response.warningMessage)
        )
    }

    private fun mapToArc59WarningMessage(warningMessage: Arc59WarningMessageResponse?): Arc59SummaryWarningMessage? {
        if (warningMessage == null) return null
        return Arc59SummaryWarningMessage(
            title = warningMessage.title,
            detail = warningMessage.detail,
            readMoreUrl = warningMessage.link,
            readMoreText = warningMessage.linkText
        )
    }
