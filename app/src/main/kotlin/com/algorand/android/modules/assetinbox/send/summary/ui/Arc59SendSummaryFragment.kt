...
import com.algorand.android.modules.assetinbox.send.warning.ui.Arc59SendSummaryWarningBottomSheet.Companion.ARC59_SEND_CONFIRMATION
...
class Arc59SendSummaryFragment : BaseFragment(R.layout.fragment_arc59_send_summary) {
    ...
    private fun navigateToReadMore() {
        context?.openUrl(arc59SendSummaryViewModel.getReadMoreUrl())
    }
