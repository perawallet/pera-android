...
class ShouldDisplayNFTInAssetsPreferenceUseCase @Inject constructor(
    ...
    suspend operator fun invoke(): Boolean {
        return assetFilterRepository.getDisplayNFTInAssetsPreference(DEFAULT_PREFERENCE_VALUE)
    }
