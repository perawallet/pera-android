...
import com.algorand.android.modules.autolockmanager.data.repository.AutoLockRepositoryImpl
...
object AutoLockDataModule {

    @Provides
    @Named(AutoLockRepository.INJECTION_NAME)
    fun provideAutoLockRepository(
        appAtBackgroundPreferencesLocalSource: AppAtBackgroundPreferencesLocalSource
    ): AutoLockRepository {
        return AutoLockRepositoryImpl(
            appAtBackgroundPreferencesLocalSource = appAtBackgroundPreferencesLocalSource
        )
    }
}
