...
class SetAppAtBackgroundTimeUseCase @Inject constructor(
    @Named(AutoLockRepository.INJECTION_NAME)
    private val autoLockRepository: AutoLockRepository
) {

    operator fun invoke(appAtBackgroundTime: Long) {
        autoLockRepository.setAppAtBackgroundTime(appAtBackgroundTime)
    }
}
