...
class TitleItemViewHolder(
    private val binding: ItemLedgerInformationTitleBinding
) : RecyclerView.ViewHolder(binding.root) {

    fun bind(titleItem: LedgerInformationListItem.TitleItem) {
        binding.titleTextView.setText(titleItem.titleRes)
    }

    companion object {
        fun create(parent: ViewGroup): TitleItemViewHolder {
            val binding = ItemLedgerInformationTitleBinding.inflate(LayoutInflater.from(parent.context), parent, false)
