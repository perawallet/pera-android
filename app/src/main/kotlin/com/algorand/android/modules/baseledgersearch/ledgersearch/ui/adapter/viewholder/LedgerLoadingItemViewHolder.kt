...
class LedgerLoadingItemViewHolder(binding: ItemLedgerSearchLoadingBinding) : RecyclerView.ViewHolder(binding.root) {
    companion object {
        fun create(parent: ViewGroup): LedgerLoadingItemViewHolder {
            val binding = ItemLedgerSearchLoadingBinding.inflate(LayoutInflater.from(parent.context), parent, false)
            return LedgerLoadingItemViewHolder(binding)
        }
    }
}
