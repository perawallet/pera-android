...
abstract class BaseMultipleAccountSelectionViewModel : BaseViewModel() {

    abstract val multipleAccountSelectionPreviewFlow: StateFlow<BaseMultipleAccountSelectionFields>
}
