...
internal class OwnedCollectibleAudioDataMapperImpl @Inject constructor() : OwnedCollectibleAudioDataMapper {
    ...
    override fun invoke(
        ...
        optedInAtRound: Long?
    ): BaseAccountAssetData.BaseOwnedAssetData.BaseOwnedCollectibleData.OwnedCollectibleAudioData {
        return BaseAccountAssetData.BaseOwnedAssetData.BaseOwnedCollectibleData.OwnedCollectibleAudioData(
