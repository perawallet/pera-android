...
class SaveDisplayWatchAccountNFTsPreferenceUseCase @Inject constructor(
    ...
    suspend operator fun invoke(showWatchAccountNFTsPreferences: Boolean) {
        collectibleFiltersRepository.saveDisplayWatchAccountNFTsPreference(showWatchAccountNFTsPreferences)
    }
}
