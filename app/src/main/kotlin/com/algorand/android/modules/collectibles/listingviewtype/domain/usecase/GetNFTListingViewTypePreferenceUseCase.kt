...
class GetNFTListingViewTypePreferenceUseCase @Inject constructor(
    ...
    suspend operator fun invoke(): NFTListingViewType {
        val viewTypeOrdinal = nftListingViewTypeRepository.getNFTListingViewTypePreference()
        return nftListingViewTypeDecider.decideNFTListingViewType(viewTypeOrdinal)
    }
}
