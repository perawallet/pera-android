...
class SaveNFTListingViewTypePreferenceUseCase @Inject constructor(
    ...
    suspend operator fun invoke(nftListingViewType: NFTListingViewType) {
        if (nftListingViewType.ordinal == nftListingViewTypeRepository.getNFTListingViewTypePreference()) return
        nftListingViewTypeRepository.saveNFTListingViewTypePreference(nftListingViewType.ordinal)
    }
}
