...
class CurrencyOptionMapper @Inject constructor() {

    fun mapToCurrencyOption(currencyOptionResponse: CurrencyOptionResponse): CurrencyOption {
        return with(currencyOptionResponse) {
            CurrencyOption(
                currencyId = id,
                currencyName = name
            )
