...
class NameServiceSourceMapper @Inject constructor() {
    ...
    fun mapToNameServiceSource(nameServiceSourceDTO: NameServiceSourceDTO?): NameServiceSource? {
        return when (nameServiceSourceDTO) {
            NameServiceSourceDTO.NFDOMAIN -> NameServiceSource.NFDOMAIN
            NameServiceSourceDTO.UNKNOWN -> NameServiceSource.UNKNOWN
            null -> null
        }
    }
}
