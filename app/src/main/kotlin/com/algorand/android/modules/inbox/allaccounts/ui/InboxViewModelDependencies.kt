...
data class InboxViewModelDependencies(
    val inboxViewStateMapper: InboxViewStateMapper,
    val getInboxValidAddresses: GetInboxValidAddresses,
    val getInboxMessagesFlow: GetInboxMessagesFlow,
    val refreshInboxCache: RefreshInboxCache,
    val setInboxLastOpenedTime: SetInboxLastOpenedTime,
    val getInboxLastOpenedTime: GetInboxLastOpenedTime,
