...
package com.algorand.android.modules.rekey.rekeytojointaccount.accountselection.ui.mapper
...
class RekeyToJointAccountSelectionPreviewMapper @Inject constructor() {

    fun mapToRekeyToJointAccountSelectionPreview(
        isLoading: Boolean,
        singleAccountSelectionListItems: List<SingleAccountSelectionListItem>,
        screenState: ScreenState?
    ): RekeyToJointAccountSelectionPreview {
        return RekeyToJointAccountSelectionPreview(
            isLoading = isLoading,
