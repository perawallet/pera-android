...
package com.algorand.android.modules.rekey.rekeytojointaccount.confirmation.ui.usecase
...
import com.algorand.android.modules.rekey.rekeytojointaccount.confirmation.ui.mapper.RekeyToJointAccountConfirmationPreviewMapper
import com.algorand.android.modules.rekey.rekeytojointaccount.confirmation.ui.model.RekeyToJointAccountConfirmationPreview
...
class RekeyToJointAccountConfirmationPreviewUseCase @Inject constructor(
    private val rekeyToJointAccountConfirmationPreviewMapper: RekeyToJointAccountConfirmationPreviewMapper,
    ...
    fun sendRekeyToJointAccountTransaction(
        preview: RekeyToJointAccountConfirmationPreview,
        transactionDetail: SignedTransactionDetail.RekeyOperation
    ): Flow<RekeyToJointAccountConfirmationPreview> = flow {
        ...
        sendSignedTransactionUseCase.invoke(transactionDetail).useSuspended(
            ...
            onFailed = {
                ...
                emit(
                    preview.copy(
                        showGlobalErrorEvent = Event(title to description),
                        isLoading = false
                    )
                )
            }
    ...
    suspend fun getInitialRekeyToJointAccountConfirmationPreview(
        accountAddress: String,
        authAccountAddress: String
    ): RekeyToJointAccountConfirmationPreview {
        ...
        val displayName = getAccountDisplayName(
            accountAddress,
            accountLite?.customName,
            accountLite?.cachedInfo?.type
        )
        ...
        return rekeyToJointAccountConfirmationPreviewMapper.mapToRekeyToJointAccountConfirmationPreview(
            isLoading = false,
            descriptionAnnotatedString = getDescriptionAnnotatedString(isAccountRekeyed),
