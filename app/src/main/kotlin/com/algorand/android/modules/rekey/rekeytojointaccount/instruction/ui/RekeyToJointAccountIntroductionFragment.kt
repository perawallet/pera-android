...
@AndroidEntryPoint
class RekeyToJointAccountIntroductionFragment : BaseIntroductionFragment() {

    override val fragmentConfiguration: FragmentConfiguration = FragmentConfiguration()

    override val baseIntroductionViewModel: BaseIntroductionViewModel
        get() = rekeyToJointAccountIntroductionViewModel

    private val rekeyToJointAccountIntroductionViewModel by viewModels<RekeyToJointAccountIntroductionViewModel>()
    ...
    override fun onActionButtonClick() {
        val accountAddress = rekeyToJointAccountIntroductionViewModel.accountAddress
        nav(
            RekeyToJointAccountIntroductionFragmentDirections
                .actionRekeyToJointAccountInstructionFragmentToRekeyToJointAccountSelectionFragment(
    ...
    override fun initObservers() {
        super.initObservers()
        with(rekeyToJointAccountIntroductionViewModel.introductionPreviewFlow) {
    ...
    private fun inflateExpectationContent(expectationList: List<AnnotatedString>) {
        with(viewStubBinding.expectationItemsLinearLayout) {
            ...
            expectationList.forEachIndexed { index, annotatedString ->
                ...
                numberedListItemView.updateLayoutParams<MarginLayoutParams> {
