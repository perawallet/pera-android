...
import com.algorand.android.modules.rekey.rekeytojointaccount.resultinfo.ui.RekeyToJointAccountVerifyInfoViewModel.ViewState
...
@HiltViewModel
class RekeyToJointAccountVerifyInfoViewModel @Inject constructor(
    private val getAccountDisplayName: GetAccountDisplayName,
    private val stateDelegate: StateDelegate<ViewState>,
    savedStateHandle: SavedStateHandle
) : BaseViewModel(), StateViewModel<ViewState> by stateDelegate {

    private val navArgs = RekeyToJointAccountVerifyInfoFragmentArgs.fromSavedStateHandle(savedStateHandle)
