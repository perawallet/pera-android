...
import com.algorand.android.modules.sorting.assetsorting.data.repository.AssetSortPreferencesRepositoryImpl
...
class AssetSortPreferencesModule {

    @Named(AssetSortPreferencesRepository.INJECTION_NAME)
    @Provides
    fun provideCollectibleSortPreferencesRepository(
        assetSortPreferencesLocalSource: AssetSortPreferencesLocalSource
    ): AssetSortPreferencesRepository {
        return AssetSortPreferencesRepositoryImpl(assetSortPreferencesLocalSource)
    }
}
