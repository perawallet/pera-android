...
class AssetSortPreferencesLocalSource @Inject constructor(
    sharedPreferences: SharedPreferences
) : SharedPrefLocalSource<String>(sharedPreferences) {

    override val key: String
        get() = ASSET_SORT_PREFERENCE_KEY
    ...
    companion object {
        private const val ASSET_SORT_PREFERENCE_KEY = "asset_sort_preference"
    }
}
