...
class AssetSortTypeUseCase @Inject constructor(
    ...
    suspend fun getSortPreferenceType(): AssetSortPreference {
        return assetSortPreferencesRepository.getAssetSortPreference(AssetSortPreference.getDefaultSortPreference())
    }

    suspend fun saveSortPreferenceType(sortType: AssetSortPreference) {
        assetSortPreferencesRepository.saveAssetSortPreference(sortType)
    }
}
