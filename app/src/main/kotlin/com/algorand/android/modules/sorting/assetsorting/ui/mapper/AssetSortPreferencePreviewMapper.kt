...
class AssetSortPreferencePreviewMapper @Inject constructor() {

    fun mapToAssetSortPreferencePreview(
        isAlphabeticallyAscendingSelected: Boolean,
        isAlphabeticallyDescendingSelected: Boolean,
        isBalanceAscendingSelected: Boolean,
        isBalanceDescendingSelected: Boolean
    ): AssetSortPreferencePreview {
        return AssetSortPreferencePreview(
            ...
            isBalanceAscendingSelected = isBalanceAscendingSelected,
            isBalanceDescendingSelected = isBalanceDescendingSelected
        )
    }
}
