...
package com.algorand.android.modules.sorting.nftsorting.domain.repository

import com.algorand.android.modules.sorting.nftsorting.domain.model.CollectibleSortPreference

interface CollectibleSortPreferencesRepository {

    suspend fun saveCollectibleSortPreference(sortType: CollectibleSortPreference)
