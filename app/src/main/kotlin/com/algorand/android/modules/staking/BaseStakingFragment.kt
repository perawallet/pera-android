...
abstract class BaseStakingFragment : BasePeraWebViewFragment(R.layout.fragment_staking),
    PeraMobileWebInterface.WebInterfaceListener {

    protected val stakingViewModel: StakingViewModel by viewModels()

    override lateinit var binding: FragmentStakingBinding

    abstract fun getStakingUrl(): String
    ...
    private fun initWebView() {
        with(binding) {
            val peraWebInterface = PeraMobileWebInterface.create(this@BaseStakingFragment)
