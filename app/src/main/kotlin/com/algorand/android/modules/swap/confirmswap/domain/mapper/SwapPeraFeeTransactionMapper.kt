...
class SwapPeraFeeTransactionMapper @Inject constructor() {
    ...
    fun mapToFeeTxn(
        ...
        transactionNodeNetworkSlug: String
    ): SwapQuoteTransaction.PeraFeeTransaction {
        return SwapQuoteTransaction.PeraFeeTransaction(
            transactionGroupId = transactionGroupId,
            unsignedTransactions = unsignedTransactions,
            signedTransactions = signedTransactions,
            transactionNodeNetworkSlug = transactionNodeNetworkSlug
        )
    }
}
