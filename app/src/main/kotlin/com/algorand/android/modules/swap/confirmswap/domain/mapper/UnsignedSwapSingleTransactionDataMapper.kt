...
class UnsignedSwapSingleTransactionDataMapper @Inject constructor() {

    fun mapToUnsignedSwapSingleTransactionData(
        parentListIndex: Int,
        transactionListIndex: Int,
        transactionMsgPack: String?,
        accountAddress: String,
        accountAuthAddress: String?,
        rawTransaction: RawTransaction?
    ): UnsignedSwapSingleTransactionData {
        return UnsignedSwapSingleTransactionData(
            parentListIndex = parentListIndex,
            transactionListIndex = transactionListIndex,
            transactionMsgPack = transactionMsgPack,
            accountAddress = accountAddress,
            accountAuthAddress = accountAuthAddress,
            decodedTransaction = rawTransaction
        )
    }
}
