...
import com.algorand.android.modules.swap.introduction.data.repository.SwapFeatureIntroductionPageRepositoryImpl
...
object SwapFeatureIntroductionModule {

    @Provides
    @Named(SwapFeatureIntroductionPageRepository.INJECTION_NAME)
    fun provideSwapFeatureIntroductionPageRepository(
        swapFeatureIntroductionPagePreferenceLocalSource: SwapFeatureIntroductionPagePreferenceLocalSource
