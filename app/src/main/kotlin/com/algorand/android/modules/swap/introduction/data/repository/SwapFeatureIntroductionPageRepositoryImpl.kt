...
class SwapFeatureIntroductionPageRepositoryImpl(
    private val swapFeatureIntroductionPagePreferenceLocalSource: SwapFeatureIntroductionPagePreferenceLocalSource
    ...
    override suspend fun setSwapFeatureIntroductionPageVisibility(isVisible: Boolean) {
        swapFeatureIntroductionPagePreferenceLocalSource.saveData(isVisible)
    }
}
