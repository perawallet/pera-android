...
class SwapTransactionSummaryPreviewMapper @Inject constructor() {

    fun mapToSwapSummaryPreview(
        baseSwapTransactionSummaryItems: List<BaseSwapTransactionSummaryItem>,
    ): SwapTransactionSummaryPreview {
        return SwapTransactionSummaryPreview(
            baseSwapTransactionSummaryItems = baseSwapTransactionSummaryItems
        )
    }
}
