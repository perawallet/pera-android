...
class SwapPriceRatioProviderMapper @Inject constructor() {

    fun mapToSwapPriceRatioProvider(swapQuote: SwapQuote): SwapPriceRatioProvider {
        return with(swapQuote) {
            SwapPriceRatioProvider(
                fromAssetShortName = fromAssetDetail.shortName,
                fromAmount = fromAssetAmount,
                fromAssetDecimal = fromAssetDetail.fractionDecimals,
                toAssetShortName = toAssetDetail.shortName,
