...
class AccountDetailFragmentEventTracker @Inject constructor(
    ...
    suspend fun logAccountDetailAssetsTapEvent() {
        accountDetailAssetsTapEventTracker.logAccountDetailAssetsTapEvent()
    }

    suspend fun logAccountDetailCollectiblesTapEvent() {
        accountDetailCollectiblesTapEventTracker.logAccountDetailCollectiblesTapEvent()
    }
