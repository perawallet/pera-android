...
class AccountDetailTransactionHistoryTapEventTracker @Inject constructor(
    peraEventTracker: PeraEventTracker
) : BaseEventTracker(peraEventTracker) {

    suspend fun logAccountDetailTransactionHistoryTapEvent() {
        logEvent(ACCOUNT_DETAIL_HISTORY_TAP_EVENT_KEY)
    }

    companion object {
        private const val ACCOUNT_DETAIL_HISTORY_TAP_EVENT_KEY = "accountscr_history_tap"
    }
}
