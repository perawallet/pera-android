...
class VisitGovernanceEventTracker @Inject constructor(
    peraEventTracker: PeraEventTracker
) : BaseEventTracker(peraEventTracker) {

    suspend fun logVisitGovernanceEvent() {
        logEvent(VISIT_GOVERNANCE_EVENT_KEY)
    }

    companion object {
        private const val VISIT_GOVERNANCE_EVENT_KEY = "homescr_visitgovernance"
    }
}
