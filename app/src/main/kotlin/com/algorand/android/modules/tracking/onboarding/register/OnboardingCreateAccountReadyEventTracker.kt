...
class OnboardingCreateAccountReadyEventTracker @Inject constructor(
    peraEventTracker: PeraEventTracker,
    registrationUseCase: RegistrationUseCase
) : BaseOnboardingEvenTracker(peraEventTracker, registrationUseCase) {

    suspend fun logOnboardingCreateAccountReadyEvent() {
        logOnboardingEvent(ONBOARDING_CREATE_ACCOUNT_READY_EVENT_KEY)
    }
