...
class OnboardingVerifyPassphraseEventTracker @Inject constructor(
    peraEventTracker: PeraEventTracker,
    registrationUseCase: RegistrationUseCase
) : BaseOnboardingEvenTracker(peraEventTracker, registrationUseCase) {

    suspend fun logOnboardingVerifyPassphraseEvent() {
        logOnboardingEvent(ONBOARDING_VERIFY_PASSPHRASE_EVENT_KEY)
    }

    companion object {
        private const val ONBOARDING_VERIFY_PASSPHRASE_EVENT_KEY = "onb_createacc_pass_verify"
    }
}
