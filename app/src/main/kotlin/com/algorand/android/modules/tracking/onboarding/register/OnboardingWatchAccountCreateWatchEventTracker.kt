...
class OnboardingWatchAccountCreateWatchEventTracker @Inject constructor(
    peraEventTracker: PeraEventTracker,
    registrationUseCase: RegistrationUseCase
) : BaseOnboardingEvenTracker(peraEventTracker, registrationUseCase) {

    suspend fun logOnboardingWatchAccountCreateWatchEvent() {
        logOnboardingEvent(ONBOARDING_WATCH_ACCOUNT_CREATE_EVENT_KEY)
    }
