...
class OnboardingWatchAccountVerifyEventTracker @Inject constructor(
    peraEventTracker: PeraEventTracker,
    registrationUseCase: RegistrationUseCase
) : BaseOnboardingEvenTracker(peraEventTracker, registrationUseCase) {

    suspend fun logOnboardingWatchAccountVerifyEvent() {
        logOnboardingEvent(ONBOARDING_WATCH_ACCOUNT_VERIFY_EVENT_KEY)
    }
