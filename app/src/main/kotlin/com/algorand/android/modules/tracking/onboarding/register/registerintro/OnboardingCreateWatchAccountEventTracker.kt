...
class OnboardingCreateWatchAccountEventTracker @Inject constructor(
    ...
    suspend fun logOnboardingCreateWatchAccountEvent() {
        logOnboardingEvent(ONBOARDING_CREATE_WATCH_ACCOUNT_EVENT_KEY)
    }

    companion object {
        private const val ONBOARDING_CREATE_WATCH_ACCOUNT_EVENT_KEY = "onb_createacc_watch"
    }
}
