...
class AssetFreezeDTOMapper @Inject constructor() {

    fun mapToAssetFreezeDTO(assetFreezeResponse: AssetFreezeResponse): AssetFreezeDTO {
        with(assetFreezeResponse) {
            return AssetFreezeDTO(
                receiverAddress = receiverAddress,
                assetId = assetId,
                newFreezeStatus = newFreezeStatus
            )
        }
    }
}
