...
class KeyRegTransactionDTOMapper @Inject constructor() {

    fun mapToKeyRegTransactionDTO(response: KeyRegTransactionResponse): KeyRegTransactionDTO {
        return KeyRegTransactionDTO(
