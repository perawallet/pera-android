...
class SignatureDTOMapper @Inject constructor() {

    fun mapToSignatureDTO(signatureResponse: SignatureResponse): SignatureDTO {
        return SignatureDTO(signatureResponse.signatureKey)
    }
}
