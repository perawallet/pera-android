...
class TransactionTypeDTOMapper @Inject constructor() {

    fun mapToTransactionTypeDTO(transactionTypeResponse: TransactionTypeResponse): TransactionTypeDTO {
        return when (transactionTypeResponse) {
            TransactionTypeResponse.PAY_TRANSACTION -> TransactionTypeDTO.PAY_TRANSACTION
            TransactionTypeResponse.ASSET_TRANSACTION -> TransactionTypeDTO.ASSET_TRANSACTION
