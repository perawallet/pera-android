...
class ClearInnerTransactionStackCacheUseCase @Inject constructor(
    ...
    suspend fun clearInnerTransactionStackCacheUseCase() {
        transactionDetailRepository.clearInnerTransactionStackCache()
    }
}
