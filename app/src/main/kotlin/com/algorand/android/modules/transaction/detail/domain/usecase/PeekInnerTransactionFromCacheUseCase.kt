...
class PeekInnerTransactionFromCacheUseCase @Inject constructor(
    ...
    suspend fun peekInnerTransactionFromCacheUseCase(): List<BaseTransactionDetail>? {
        return transactionDetailRepository.peekInnerTransactionFromStackCache()
    }
}
