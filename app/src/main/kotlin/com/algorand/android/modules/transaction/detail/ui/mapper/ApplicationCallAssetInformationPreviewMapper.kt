...
class ApplicationCallAssetInformationPreviewMapper @Inject constructor() {

    fun mapToApplicationCallAssetInformationPreview(
        applicationCallAssetInformationListItems: List<BaseApplicationCallAssetInformationListItem>
    ): ApplicationCallAssetInformationPreview {
        return ApplicationCallAssetInformationPreview(applicationCallAssetInformationListItems)
    }
}
