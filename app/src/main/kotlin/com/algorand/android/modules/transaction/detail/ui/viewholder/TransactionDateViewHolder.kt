...
import com.algorand.android.databinding.ItemTransactionDateBinding
import com.algorand.android.models.BaseViewHolder
import com.algorand.android.modules.transaction.detail.ui.model.TransactionDetailItem

class TransactionDateViewHolder(
    ...
    override fun bind(item: TransactionDetailItem) {
        if (item !is TransactionDetailItem.StandardTransactionItem.DateItem) return
        with(binding) {
