...
class TransactionHistoryDataSource @Inject constructor(
    private val onLoad: suspend (nextKey: String?) -> LoadResult<String, BaseTransaction.Transaction>
) : PeraPagingSource<String, BaseTransaction.Transaction>() {

    override val logTag: String = TransactionHistoryDataSource::class.java.simpleName

    override suspend fun initializeData(): LoadResult<String, BaseTransaction.Transaction> {
        return onLoad(null)
    }

    override suspend fun loadMore(loadUrl: String): LoadResult<String, BaseTransaction.Transaction> {
