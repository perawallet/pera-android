...
object WalletConnectClientErrorMessageUtils {

    fun createDappErrorMessage(walletConnectError: WalletConnectError, code: Long): String {
        return "${walletConnectError.errorCategory}($code)\n${walletConnectError.message}"
    }
}
