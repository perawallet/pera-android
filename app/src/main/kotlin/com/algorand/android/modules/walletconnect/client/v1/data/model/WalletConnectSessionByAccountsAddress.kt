...
data class WalletConnectSessionByAccountsAddress(
    @Embedded
    val walletConnectSessionAccount: WalletConnectSessionAccountEntity,
    @Relation(
        parentColumn = WALLET_CONNECT_SESSION_ACCOUNT_TABLE_SESSION_ID_COLUMN_NAME,
        entityColumn = WALLET_CONNECT_SESSION_TABLE_SESSION_ID_COLUMN_NAME
    )
    val walletConnectSession: WalletConnectSessionEntity
)
