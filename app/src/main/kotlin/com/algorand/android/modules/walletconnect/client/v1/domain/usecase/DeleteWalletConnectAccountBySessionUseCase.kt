...
class DeleteWalletConnectAccountBySessionUseCase @Inject constructor(
    ...
    suspend operator fun invoke(sessionId: Long, accountAddress: String) {
        return walletConnectRepository.deleteWalletConnectAccountBySession(sessionId, accountAddress)
    }
}
