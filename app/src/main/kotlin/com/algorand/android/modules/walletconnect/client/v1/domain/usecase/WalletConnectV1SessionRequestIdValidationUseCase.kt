...
class WalletConnectV1SessionRequestIdValidationUseCase @Inject constructor(
    @Named(WalletConnectRepository.INJECTION_NAME)
    private val walletConnectRepository: WalletConnectRepository
) {

    suspend fun isRequestAlreadyShown(requestId: Long): Boolean {
        return walletConnectRepository.isSessionRequestIdExist(requestId)
    }

    suspend fun setRequestShown(requestId: Long) {
        walletConnectRepository.setSessionRequestId(
            requestId = requestId,
