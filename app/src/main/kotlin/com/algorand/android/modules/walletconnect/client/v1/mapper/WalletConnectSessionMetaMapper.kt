...
class WalletConnectSessionMetaMapper @Inject constructor() {
    ...
    fun mapToSessionMeta(sessionMeta: Session.Config): WalletConnect.Session.Meta {
        return WalletConnect.Session.Meta.Version1(
            bridge = sessionMeta.bridge.orEmpty(),
            topic = sessionMeta.handshakeTopic,
            key = sessionMeta.key.orEmpty(),
            version = sessionMeta.version.toString()
        )
    }
}
