...
class WalletConnectSessionDtoMapper @Inject constructor() {
    ...
    fun mapToSessionDto(entity: WalletConnectV2SessionEntity): WalletConnectSessionDto {
        return WalletConnectSessionDto(
            topic = entity.topic,
            creationDateTimestamp = entity.dateTimeStamp,
            fallbackBrowserGroupResponse = entity.fallbackBrowserGroupResponse
        )
    }
}
