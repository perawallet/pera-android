...
import com.algorand.android.modules.walletconnect.client.v2.model.WalletConnectV2RequestIdentifier
...
class WalletConnectV2RequestIdentifierMapper @Inject constructor() : WalletConnectRequestIdentifierMapper<Long> {

    override fun mapToRequestIdentifier(requestIdentifier: Long): WalletConnect.RequestIdentifier {
        return WalletConnectV2RequestIdentifier(requestIdentifier)
    }
}
