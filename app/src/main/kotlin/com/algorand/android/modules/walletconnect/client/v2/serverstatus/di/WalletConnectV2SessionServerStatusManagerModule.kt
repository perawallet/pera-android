...
import com.algorand.android.modules.walletconnect.client.v2.serverstatus.WalletConnectV2SessionServerStatusManagerImpl
...
object WalletConnectV2SessionServerStatusManagerModule {

    @Provides
    @Named(WalletConnectV2SessionServerStatusManager.INJECTION_NAME)
    fun provideWalletConnectSessionServerStatusManager(
        signClient: WalletConnectV2SignClient,
        clientV2Mapper: WalletConnectClientV2Mapper
    ): WalletConnectV2SessionServerStatusManager {
        return WalletConnectV2SessionServerStatusManagerImpl(signClient, clientV2Mapper)
    }
}
