...
class WCRequestLaunchBackDescriptionAnnotatedStringProviderV2Impl(
    ...
    override suspend fun provideAnnotatedString(
        ...
        return if (hasSessionReachedMaxValidity == true) {
            ...
            AnnotatedString(
                stringResId = R.string.the_transaction_has_been_signed_and_sent,
    ...
    companion object {
        const val INJECTION_NAME: String = "wcTransactionLaunchBackDescriptionAnnotatedStringV2InjectionName"
    }
}
