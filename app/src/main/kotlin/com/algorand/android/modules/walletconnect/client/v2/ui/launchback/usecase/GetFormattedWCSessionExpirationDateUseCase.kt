...
class GetFormattedWCSessionExpirationDateUseCase @Inject constructor(
    private val walletConnectManager: WalletConnectManager
) {

    suspend operator fun invoke(sessionIdentifier: WalletConnectSessionIdentifier): String {
        return walletConnectManager.getSessionExpirationDateTimeStampAsSec(sessionIdentifier)
