...
class GetFormattedWCSessionExtendedExpirationDateUseCase @Inject constructor(
    private val walletConnectManager: WalletConnectManager
) {

    suspend operator fun invoke(sessionIdentifier: WalletConnectSessionIdentifier): String {
        return walletConnectManager.getSessionExpirationDateExtendedTimeStampAsSec(sessionIdentifier)
