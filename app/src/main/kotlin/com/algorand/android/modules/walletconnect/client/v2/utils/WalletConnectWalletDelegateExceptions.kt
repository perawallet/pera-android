...
sealed class WalletConnectWalletDelegateExceptions(message: String?) : Exception(message) {

    sealed class MissingPeerMetaDataException(
        override val message: String?
    ) : WalletConnectWalletDelegateExceptions(message) {
