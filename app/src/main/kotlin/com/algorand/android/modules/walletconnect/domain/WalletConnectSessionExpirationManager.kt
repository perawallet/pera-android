...
interface WalletConnectSessionExpirationManager {

    suspend fun extendSessionExpirationDate(sessionIdentifier: WalletConnect.SessionIdentifier): Result<String>

    suspend fun isSessionExtendable(sessionIdentifier: WalletConnect.SessionIdentifier): Boolean

    suspend fun hasSessionReachedMaxValidity(sessionIdentifier: WalletConnect.SessionIdentifier): Boolean
