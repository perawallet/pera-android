...
class WalletConnectProposalIdentifierDecider @Inject constructor(
    private val walletConnectV1ProposalIdentifierMapper: WalletConnectV1ProposalIdentifierMapper,
    private val walletConnectV2ProposalIdentifierMapper: WalletConnectV2ProposalIdentifierMapper
) {

    fun decideProposalIdentifier(
