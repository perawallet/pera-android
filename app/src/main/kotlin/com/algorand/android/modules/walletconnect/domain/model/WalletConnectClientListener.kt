...
interface WalletConnectClientListener {
    ...
    fun onSessionSettle(settle: WalletConnect.Session.Settle)
    fun onSessionError(error: WalletConnect.Session.Error)
    fun onSessionRequest(sessionRequest: WalletConnect.Model.SessionRequest)
    fun onConnectionChanged(connectionState: WalletConnect.Model.ConnectionState)
