...
package com.algorand.android.modules.walletconnect.launchback.connection.ui.mapper
...
class WcConnectionLaunchBackBrowserPreviewMapper @Inject constructor() {

    fun mapToWcConnectionLaunchBackBrowserPreview(
        iconResId: Int,
        iconTintResId: Int,
        ...
        sessionInformationAnnotatedString: AnnotatedString?
    ): WCConnectionLaunchBackBrowserPreview {
        return WCConnectionLaunchBackBrowserPreview(
            iconResId = iconResId,
