...
@AndroidEntryPoint
class WcRequestLaunchBackBrowserBottomSheet : WcLaunchBackBrowserBottomSheet() {

    override val wcLaunchBackBrowserViewModel: WcLaunchBackBrowserViewModel
        get() = wcRequestLaunchBackBrowserViewModel

    private val wcRequestLaunchBackBrowserViewModel by viewModels<WcRequestLaunchBackBrowserViewModel>()
}
