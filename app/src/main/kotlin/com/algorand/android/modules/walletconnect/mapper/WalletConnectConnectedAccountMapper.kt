...
class WalletConnectConnectedAccountMapper @Inject constructor() {

    fun mapToConnectedAccount(
        accountAddress: String,
        chainIdentifier: WalletConnect.ChainIdentifier,
        blockchain: WalletConnectBlockchain
    ): WalletConnectConnectedAccount {
        return WalletConnectConnectedAccount(
