...
class WebImportResultPreviewMapper @Inject constructor() {

    fun mapToWebImportResultPreview(
        listItems: List<BaseAccountResultListItem>,
        buttonTextRes: Int
    ): WebImportResultPreview {
        return WebImportResultPreview(
            listItems = listItems,
