...
internal class DefaultNotificationMetadataMapper @Inject constructor() : NotificationMetadataMapper {

    override fun map(dto: NotificationMetadataDto, alertMessage: String?): NotificationMetadata {
