...
internal class GetCompactSecondaryAmountRendererUseCase @Inject constructor(
    ...
    override fun invoke(amount: PeraAmount, amountRendererType: AmountRenderer.RenderType): AmountRenderer {
        ...
        return AmountRenderer(formattedAmount, amountRendererType, getSecondaryCurrencySymbol())
    }
}
