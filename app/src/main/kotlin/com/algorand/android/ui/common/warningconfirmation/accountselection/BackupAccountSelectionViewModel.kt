...
class BackupAccountSelectionViewModel @Inject constructor(
    ...
    val backupAccountSelectionPreviewFlow: StateFlow<BackupAccountSelectionPreview>
        get() = _backupAccountSelectionPreviewFlow

    init {
        initBackupAccountSelectionPreviewFlow()
    }

    private fun initBackupAccountSelectionPreviewFlow() {
        viewModelScope.launch {
            _backupAccountSelectionPreviewFlow.value = backupAccountSelectionPreviewUseCase
                .getBackupAccountSelectionPreview()
        }
    }
}
