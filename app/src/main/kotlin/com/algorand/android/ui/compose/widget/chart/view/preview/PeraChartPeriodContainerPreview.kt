...
@Preview
@Composable
fun PeraChartPeriodContainerPreview() {
    PeraChartPeriodContainer {
        PeraChartPeriodChip(text = "1D", false) {}
        PeraChartPeriodChip(text = "1W", false) {}
        PeraChartPeriodChip(text = "1M", true) {}
        PeraChartPeriodChip(text = "1Y", false) {}
    }
}
