...
class ContactBackupDeleteConfirmationBottomSheet : BaseDoubleButtonBottomSheet() {
    ...
    override fun setDescriptionText(textView: TextView) {
        textView.setText(R.string.delete_contact_from_cloud_backup_description)
    }
    ...
    override fun setAcceptButton(materialButton: MaterialButton) {
        materialButton.apply {
            ...
            setOnClickListener {
                navBack()
                setFragmentNavigationResult(CONTACT_BACKUP_DELETE_CONFIRMATION_KEY, true)
            }
        }
    }
    ...
    override fun setCancelButton(materialButton: MaterialButton) {
        materialButton.apply {
            ...
            setOnClickListener {
                navBack()
                setFragmentNavigationResult(CONTACT_BACKUP_DELETE_CONFIRMATION_KEY, false)
            }
        }
    }
    ...
    companion object {
        const val CONTACT_BACKUP_DELETE_CONFIRMATION_KEY = "contact_backup_delete_confirmation"
    }
}
