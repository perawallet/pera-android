...
import com.algorand.android.ui.password.model.PasswordScreenType.VerificationScreenType
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class DisableBiometricAuthPasswordVerificationFragment : BasePasswordFragment() {
    ...
    override val screenType: PasswordScreenType = VerificationScreenType(
        navigationResultKey = DISABLE_BIOMETRIC_AUTH_VERIFICATION_RESULT_KEY
    )
