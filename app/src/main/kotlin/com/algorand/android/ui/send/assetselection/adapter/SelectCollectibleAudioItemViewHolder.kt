...
class SelectCollectibleAudioItemViewHolder(
    ...
    companion object : SelectCollectibleItemViewHolderCreator {
        override fun create(
            parent: ViewGroup,
            listener: SelectCollectibleItemListener
        ): SelectCollectibleAudioItemViewHolder {
            return SelectCollectibleAudioItemViewHolder(createItemSelectCollectibleBinding(parent), listener)
        }
    }
}
