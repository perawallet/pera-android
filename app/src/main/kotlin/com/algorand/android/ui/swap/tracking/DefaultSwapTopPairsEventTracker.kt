...
internal class DefaultSwapTopPairsEventTracker @Inject constructor(
    peraEventTracker: PeraEventTracker
) : BaseEventTracker(peraEventTracker), SwapTopPairsEventTracker {

    override suspend fun logPairSelected(assetInName: String, assetOutName: String) {
        logEvent("swapscr_swap_top_select", mapOf("swap_pairing" to "${assetInName}_$assetOutName"))
    }
}
