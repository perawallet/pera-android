...
interface SwapAssetSelectionViewModel : StateViewModel<ViewState> {

    fun initAssetDetail(addressFlow: Flow<String?>, assetIdFlow: Flow<Long>)
    ...
    sealed interface ViewState {
        ...
        data class Content(
            val assetDetail: SwapSelectedAssetDetail,
            val balanceRenderer: AmountRenderer
        ) : ViewState
    }
}
