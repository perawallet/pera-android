...
@AndroidEntryPoint
class SwapGroupDetailFragment : BaseFragment(0), SwapGroupDetailScreenListener {

    override val fragmentConfiguration: FragmentConfiguration = FragmentConfiguration()

    private val viewModel: SwapGroupDetailViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.initTransactions(args.accountAddress, args.groupId)
    }
    ...
    override fun onTransactionClick(id: String) {
        nav(
            SwapGroupDetailFragmentDirections.actionSwapGroupDetailFragmentToTransactionDetailNavigation(
                transactionId = id,
