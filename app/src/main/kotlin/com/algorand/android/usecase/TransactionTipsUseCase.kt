...
class TransactionTipsUseCase @Inject constructor(
    private val transactionTipsRepository: TransactionTipsRepository
) {

    fun shouldShowTransactionTips(): Boolean {
        return transactionTipsRepository.shouldShowTransactionTips()
    }

    fun setTransactionTipsAsShowed() {
        transactionTipsRepository.setTransactionTipsAsShowed()
    }
}
