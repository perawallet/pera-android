...
class GovernorIconDrawable(
    ...
    companion object {
        private const val ICON_PADDING_RATIO_MULTIPLIER = .85

        fun create(context: Context, governorIconResource: GovernorIconResource, size: Int): GovernorIconDrawable? {
            return GovernorIconDrawable(
                backgroundColor = ContextCompat.getColor(context, governorIconResource.backgroundColorResId),
                iconTint = ContextCompat.getColor(context, governorIconResource.iconTintResId),
                iconDrawable = AppCompatResources.getDrawable(context, governorIconResource.iconResId) ?: return null,
                size = size
            )
        }
    }
