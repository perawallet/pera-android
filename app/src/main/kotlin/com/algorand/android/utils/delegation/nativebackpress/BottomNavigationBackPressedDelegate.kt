...
class BottomNavigationBackPressedDelegate : BackPressedControllerComponent {
    ...
    override fun initBackPressedControllerComponent(baseFragment: BaseFragment) {
        activity = baseFragment.activity as? CoreMainActivity ?: return
        activity.onBackPressedDispatcher.addCallback(baseFragment.viewLifecycleOwner, onBackPressedCallback)
    }
