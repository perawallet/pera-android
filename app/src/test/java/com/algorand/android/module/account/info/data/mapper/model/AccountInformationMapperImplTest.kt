...
import com.algorand.android.module.account.info.data.model.ParticipationResponse
...
class AccountInformationMapperImplTest {
    ...
    fun `EXPECT mapped values to be correct with asset holdings`() {
        ...
        val expected = AccountInformation(
            ...
            createdAtRound = ACCOUNT_INFORMATION_ENTITY.createdAtRound
        )
    ...
    companion object {
        ...
        private val ASSET_STATUS = fixtureOf<AssetStatus>()
