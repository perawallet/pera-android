...
import com.algorand.android.assetdetail.component.collectible.domain.model.BaseCollectibleMedia.ImageCollectibleMedia
    ...
    override fun invoke(
        ...
        return ImageCollectibleDetail(
            ...
            collectibleMedias = collectibleResponse.collectibleMedias?.map {
                ImageCollectibleMedia(it.downloadUrl, it.previewUrl)
            }.orEmpty()
        )
    }
