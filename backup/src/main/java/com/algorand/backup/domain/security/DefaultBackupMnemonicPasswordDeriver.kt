...
internal class DefaultBackupMnemonicPasswordDeriver @Inject constructor() : BackupMnemonicPasswordDeriver {

    override fun derive(mnemonic: String): SensitiveBytes {
