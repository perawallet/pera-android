...
internal class DefaultSaveBackupSyncResult @Inject constructor(
    private val getBackupId: GetBackupId,
    private val syncStateRepository: SyncStateRepository,
    private val timeProvider: TimeProvider
) : SaveBackupSyncResult {

    override suspend fun invoke(result: SyncBackupResult) {
        val backupSyncResult = when (result) {
