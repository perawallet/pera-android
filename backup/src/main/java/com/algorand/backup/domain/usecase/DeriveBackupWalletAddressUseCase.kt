...
internal class DeriveBackupWalletAddressUseCase @Inject constructor(
    private val peraBip39Sdk: PeraBip39Sdk,
    private val bip39WalletProvider: Bip39WalletProvider
) : DeriveBackupWalletAddress {

    override fun invoke(mnemonic: String): String? {
        ...
        return try {
            wallet.generateAddress(HdKeyAddressIndex()).address
        } finally {
            wallet.invalidate()
        }
    }
