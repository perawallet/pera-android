...
class CacheResultTest {
    ...
    fun `EXPECT Success to have creation timestamp WHEN it is created`() {
        val success = com.algorand.android.module.caching.CacheResult.Success.create("success")
    ...
    fun `EXPECT Error to have creation timestamp WHEN it has successfully cached data previously`() {
        val previouslyCachedData = com.algorand.android.module.caching.CacheResult.Success.create<Any>("success")
        val error = com.algorand.android.module.caching.CacheResult.Error.create<Any>(Exception(), previouslyCachedData)
    ...
    fun `EXPECT Success  to be equal WHEN data and creation timestamp are equal`() {
        val success1 = com.algorand.android.module.caching.CacheResult.Success.create("success")
        val success2 = com.algorand.android.module.caching.CacheResult.Success.create("success")
    ...
    fun `EXPECT Error to be equal WHEN exception, data and creation timestamp are equal`() {
        val previouslyCachedData = com.algorand.android.module.caching.CacheResult.Success.create<Any>("success")
        val error1 = com.algorand.android.module.caching.CacheResult.Error.create<Any>(Exception(), previouslyCachedData)
        val error2 = com.algorand.android.module.caching.CacheResult.Error.create<Any>(Exception(), previouslyCachedData)
    ...
    fun `EXPECT Error hashCode to be correct`() {
        val error = com.algorand.android.module.caching.CacheResult.Error.create<Any>(Exception(), null)
    ...
    fun `EXPECT null for previous data WHEN Error is created without it`() {
        val error = com.algorand.android.module.caching.CacheResult.Error.create<Any>(Exception())
