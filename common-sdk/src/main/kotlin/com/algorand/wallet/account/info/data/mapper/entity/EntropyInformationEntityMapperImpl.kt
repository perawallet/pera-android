...
internal class EntropyInformationEntityMapperImpl @Inject constructor() :
    EntropyInformationEntityMapper {
    override fun invoke(entropyInformation: EntropyInformation): EntropyInformationEntity {
        return EntropyInformationEntity(
