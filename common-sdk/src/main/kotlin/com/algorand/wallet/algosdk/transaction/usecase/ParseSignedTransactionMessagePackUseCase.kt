...
internal class ParseSignedTransactionMessagePackUseCase @Inject constructor(
    private val jsonSerializer: JsonSerializer,
    private val rawTransactionMapper: RawTransactionMapper,
    private val algoSdk: AlgoSdk
) : ParseSignedTransactionMessagePack {
    ...
    private fun tryParsing(txnByteArray: ByteArray): RawTransaction? {
        val transactionJson = algoSdk.signedTransactionMsgpackToJson(txnByteArray)
