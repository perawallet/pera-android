...
package com.algorand.wallet.asset.assetinbox.domain.repository
...
internal interface AssetInboxRepository {
    ...
    suspend fun getRequests(addresses: List<String>): PeraResult<List<AssetInboxRequest>>

    suspend fun cacheRequests(requests: List<AssetInboxRequest>)
