...
internal class FetchCollectibleDetailUseCase @Inject constructor(
    ...
    override suspend fun invoke(collectibleId: Long): PeraResult<CollectibleDetail> {
        val deviceId = getSelectedNodeDeviceId()
        if (deviceId.isNullOrBlank()) {
            errorLogger.logError("FetchCollectibleDetailUseCase: Device ID is null or blank.")
        }
        return assetRepository.fetchCollectibleDetail(collectibleId, deviceId)
    }
}
