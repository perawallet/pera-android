...
internal class IsJointAccountMapperImpl @Inject constructor() : IsJointAccountMapper {

    override fun mapToIsJointAccountResult(response: IsJointAccountResponse): IsJointAccountResult? {
        val address = response.address ?: return null
        val isJointAccount = response.isJointAccount ?: return null
        return IsJointAccountResult(
            address = address,
