...
internal class DismissSpotBannerUseCase @Inject constructor(
    private val getSelectedNodeDeviceId: GetSelectedNodeDeviceId,
    private val spotBannerRepository: SpotBannerRepository
) : DismissSpotBanner {

    override suspend fun invoke(bannerId: Long) {
        val selectedDeviceId = getSelectedNodeDeviceId() ?: return
        spotBannerRepository.dismissBanner(selectedDeviceId, bannerId)
    }
}
