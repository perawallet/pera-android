...
internal data class SwapQuoteResponse(
    @SerializedName("id")
    val id: Long?,
    ...
    val assetInAmount: BigInteger?,
    @SerializedName("amount_in_with_slippage")
    val assetInAmountWithSlippage: BigInteger?,
    @SerializedName("amount_in_usd_value")
    val assetInAmountInUsdValue: BigDecimal?,
    @SerializedName("amount_out")
    val assetOutAmount: BigInteger?,
    @SerializedName("amount_out_with_slippage")
    val assetOutAmountWithSlippage: BigInteger?,
    @SerializedName("amount_out_usd_value")
    val assetOutAmountInUsdValue: BigDecimal?,
