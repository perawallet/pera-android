...
package com.algorand.wallet.swap.domain.validation.di

import com.algorand.wallet.swap.domain.validation.DefaultSwapTransactionValidator
...
//    ): SwapTransactionValidationRule = rule
    ...
    @IntoSet
    @Provides
    fun provideSwapRekeyedTransactionValidationRule(
        rule: SwapRekeyedTransactionValidationRule
    ): SwapTransactionValidationRule = rule

    @IntoSet
    @Provides
    fun provideSwapSentAmountValidationRule(
        rule: SwapSentAmountValidationRule
    ): SwapTransactionValidationRule = rule

    @IntoSet
    @Provides
    fun provideSwapSignerValidationRule(
        rule: SwapSignerValidationRule
    ): SwapTransactionValidationRule = rule

    @IntoSet
    @Provides
    fun provideSwapCloseToValidationRule(
        rule: SwapCloseToValidationRule
    ): SwapTransactionValidationRule = rule

    @Provides
    fun provideSwapTransactionValidator(
        validator: DefaultSwapTransactionValidator
    ): SwapTransactionValidator = validator
}
