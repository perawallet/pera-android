...
class DiscoverDeepLinkBuilderTest {

    private val sut = DiscoverDeepLinkBuilder()
    ...
    fun `EXPECT false WHEN deeplink requirements do not match`() {
        val invalidDeepLink = VALID_DEEP_LINK.copy(host = null)
    ...
    fun `EXPECT discover deep link`() {
        ...
        val expected = DeepLink.Discover(path = "path")
