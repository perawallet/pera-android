...
class DefaultWalletWealthMapperTest {
    ...
    fun `EXPECT invalid data to be filtered WHEN result has invalid data`() {
        ...
        val expected = WalletWealth(listOf(VALID_CHART_DATA))
        assertEquals(expected, result)
    }
