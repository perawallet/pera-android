...
internal class DefaultPasskeyRepository @Inject constructor(
    ...
    override suspend fun doesPasskeyExist(rpId: String, username: String, bip39Address: String): Boolean {
        return passkeyDao.doesPasskeyExist(rpId, username, bip39Address)
    }
}
