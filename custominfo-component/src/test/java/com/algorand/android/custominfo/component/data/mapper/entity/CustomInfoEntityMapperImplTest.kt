...
internal class CustomInfoEntityMapperImplTest {
    ...
    private val sut =
        com.algorand.android.custominfo.component.data.mapper.entity.CustomInfoEntityMapperImpl(encryptionManager)

    @Test
    fun `EXPECT mapped custom info entity`() {
        whenever(encryptionManager.encrypt("address")).thenReturn("encrypted_address")
        val customInfo = com.algorand.android.custominfo.component.domain.model.CustomInfo(
            address = "address",
            order = 8,
            isBackedUp = true,
