...
package com.algorand.android.node.data.mapper

import com.algorand.android.node.domain.Node
import javax.inject.Inject

internal class NodeStorageMapperImpl @Inject constructor() : NodeStorageMapper {
    ...
    override fun invoke(nodeString: String): Node {
        return when (nodeString) {
