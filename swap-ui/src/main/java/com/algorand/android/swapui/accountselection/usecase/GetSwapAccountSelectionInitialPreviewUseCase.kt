...
internal class GetSwapAccountSelectionInitialPreviewUseCase @Inject constructor() :
    GetSwapAccountSelectionInitialPreview {

    override fun invoke(): SwapAccountSelectionPreview {
