...
data class SwapAssetSelectionPreview(
    val swapAssetSelectionItemList: List<SwapAssetSelectionItem>,
    val isLoading: Boolean,
    val screenState: ScreenState?,
    val navigateToAssetAdditionBottomSheetEvent: Event<AssetAdditionPayload>?,
    val assetSelectedEvent: Event<SwapAssetSelectionItem>?
)
