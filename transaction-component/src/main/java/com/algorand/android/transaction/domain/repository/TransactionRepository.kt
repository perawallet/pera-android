...
package com.algorand.android.transaction.domain.repository
...
internal interface TransactionRepository {
    ...
    suspend fun getTransactionParams(): PeraResult<TransactionParams>

    suspend fun sendSignedTransactions(signedTransaction: SignedTransaction): PeraResult<TransactionId>
}
