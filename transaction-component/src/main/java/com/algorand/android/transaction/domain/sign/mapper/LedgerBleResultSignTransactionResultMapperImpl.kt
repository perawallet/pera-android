...
package com.algorand.android.transaction.domain.sign.mapper

import com.algorand.android.ledger.domain.model.LedgerBleResult
import com.algorand.android.ledger.domain.model.LedgerBleResult.ErrorResult.ConnectionError
import com.algorand.android.ledger.domain.model.LedgerBleResult.ErrorResult.LedgerError
import com.algorand.android.ledger.domain.model.LedgerBleResult.ErrorResult.NetworkError
import com.algorand.android.ledger.domain.model.LedgerBleResult.ErrorResult.ReconnectLedger
import com.algorand.android.ledger.domain.model.LedgerBleResult.ErrorResult.TransmissionError
import com.algorand.android.ledger.domain.model.LedgerBleResult.ErrorResult.UnsupportedDeviceError
import com.algorand.android.ledger.domain.model.LedgerBleResult.LedgerWaitingForApproval
import com.algorand.android.ledger.domain.model.LedgerBleResult.OnBondingFailed
import com.algorand.android.ledger.domain.model.LedgerBleResult.OnLedgerDisconnected
import com.algorand.android.ledger.domain.model.LedgerBleResult.OnMissingBytes
import com.algorand.android.ledger.domain.model.LedgerBleResult.OperationCancelledResult
import com.algorand.android.ledger.domain.model.LedgerBleResult.SignedTransactionResult
...
import com.algorand.android.transaction.domain.sign.model.SignTransactionResult.TransactionSigned
