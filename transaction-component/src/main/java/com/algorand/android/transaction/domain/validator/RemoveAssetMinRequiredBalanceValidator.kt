...
import com.algorand.android.transaction.domain.TransactionConstants.MIN_REQUIRED_BALANCE_PER_ASSET
...
internal class RemoveAssetMinRequiredBalanceValidator @Inject constructor(
    private val getAccountMinBalance: GetAccountMinBalance,
    private val calculateTransactionFee: CalculateTransactionFee
) : TransactionValidator<RemoveAssetMinRequiredBalanceValidator.Payload, BigInteger> {
