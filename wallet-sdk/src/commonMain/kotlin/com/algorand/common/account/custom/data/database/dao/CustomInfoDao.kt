...
package com.algorand.common.account.custom.data.database.dao
...
internal interface CustomInfoDao {
    ...
    @Query("UPDATE custom_info SET order_index = :orderIndex WHERE :encryptedAddress = encrypted_address")
    suspend fun updateOrderIndex(encryptedAddress: String, orderIndex: Int)
