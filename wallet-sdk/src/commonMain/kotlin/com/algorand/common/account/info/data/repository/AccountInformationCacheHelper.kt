...
internal interface AccountInformationCacheHelper {
    suspend fun cacheAccountInformation(address: String, response: AccountInformationResponse): AccountInformation?
}
