...
import com.algorand.common.asset.data.repository.AssetRepositoryImpl
...
private val assetDetailKoinModule = module {
    ...
    single<AssetDetailNodeApiService> {
        AssetDetailNodeApiServiceImpl(getAlgodHttpClient(get()))
    }

    factory<AssetDetailCacheHelper> {
        AssetDetailCacheHelperImpl(get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get())
    }

    single<AssetRepository> {
        AssetRepositoryImpl(get(), get(), get(), get(), get(), get(), get(), get(), get())
    }
...
internal val assetDetailKoinModules = listOf(
    assetDetailDatabaseModule,
    assetDetailKoinModule
)
