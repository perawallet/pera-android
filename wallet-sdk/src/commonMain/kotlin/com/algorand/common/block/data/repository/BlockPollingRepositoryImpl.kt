...
package com.algorand.common.block.data.repository
...
import com.algorand.common.foundation.cache.CacheResult
import com.algorand.common.foundation.cache.SingleInMemoryLocalCache
import com.algorand.common.utils.date.TimeProvider
...
internal class BlockPollingRepositoryImpl(
    ...
    override suspend fun updateLastKnownBlockNumber(blockNumber: Long) {
        blockPollingLocalCache.put(CacheResult.Success(blockNumber, timeProvider.getCurrentTimeMillis()))
    }
    ...
    override suspend fun shouldUpdateAccountCache(localAccountAddresses: List<String>): PeraResult<Boolean> {
        ...
        return blockPollingApiService.shouldRefresh(body).map {
