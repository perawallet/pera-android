...
import com.algorand.common.encryption.EntropyEncryptionManagerImpl
...
val encryptionModule = module {
    ...
    single<SecretKeyEncryptionManager> { SecretKeyEncryptionManagerImpl(get()) }
    single<EntropyEncryptionManager> { EntropyEncryptionManagerImpl(get()) }
}
