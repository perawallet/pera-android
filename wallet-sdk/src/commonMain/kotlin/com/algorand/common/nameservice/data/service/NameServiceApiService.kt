...
internal interface NameServiceApiService {
    ...
    suspend fun fetchAccountsNameServices(body: SearchNameServiceRequestBody): PeraResult<SearchNameServiceResponse>

    suspend fun getNameServiceAccountAddresses(name: String): PeraResult<NameServiceSearchResponse>
}
